package com.ais.patient.widget.recycleview;
/**
...
public class DefineBAGRefreshWithLoadView extends BGARefreshViewHolder {
    ...
    private ProgressBar mProgressBar,mProgressBarFoot;
    ...
    public View getRefreshHeaderView() {
        if(this.mRefreshHeaderView == null) {
            ...
            this.mProgressBar = (ProgressBar)this.mRefreshHeaderView.findViewById(R.id.mProgressBar);
    ...
    public void hideLoadingMoreImg(){
        this.mProgressBarFoot.setVisibility(View.GONE);
    }
    /** 显示加载更多图片 */
    public void showLoadingMoreImg(){
        this.mProgressBarFoot.setVisibility(View.VISIBLE);
    }
    /**
     * 自定义加载更多底部
     */
    ...
    public View getLoadMoreFooterView() {
        ...
        if (this.mLoadMoreFooterView == null) {
            ...
            this.mProgressBarFoot = (ProgressBar) this.mLoadMoreFooterView.findViewById(R.id.mProgressBar);
