...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start(Context context, String contactId, SessionCustomization customization, IMMessage anchor) {
        start(context, contactId, customization, anchor, "", "", "");
    }

    public static void start(Context context, String contactId, SessionCustomization customization, IMMessage anchor, String title, String recordId, String doctorId) {
        Intent intent = new Intent();
        intent.putExtra("msgTitle", title);                     // 页面标题
        intent.putExtra("recordId", recordId);    // 问诊ID
        intent.putExtra("doctorId", doctorId);    // 医生ID
    ...
    protected MessageFragment fragment() {
        ...
        arguments.putString("recordId",getIntent().getStringExtra("recordId"));
        arguments.putString("doctorId",getIntent().getStringExtra("doctorId"));
        arguments.putString("msgTitle",getIntent().getStringExtra("msgTitle"));
       ...
       /* ToolBarOptions options = new NimToolBarOptions();
        ...
        tvDoctor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id",getIntent().getStringExtra("doctorId"));
                ComponentName cn = new ComponentName(P2PMessageActivity.this, "com.ais.patient.activity.main.DoctorInfomationActivity");
